      ...
      <div className="main-content" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <main className="fade-in mobile-main" style={{ flex: 1, overflow: "auto", padding: "20px 24px" }}>
            ...
            <div>
              ...
              <div className="dashboard-charts" style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 16, marginBottom: 16 }}>
                <div style={card}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                    ...
                    <span style={{ fontSize: 12, color: "#d71920", background: D ? "rgba(215,25,32,0.15)" : "#fff3bf", padding: "4px 12px", borderRadius: 8, fontWeight: 600 }}>{mesNombre.charAt(0).toUpperCase() + mesNombre.slice(1)}</span>
                  </div>
                  <ResponsiveContainer width="100%" height={200}>
                    <AreaChart data={salesData} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
                      <defs><linearGradient id="g" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#d71920" stopOpacity={D ? 0.3 : 0.2} /><stop offset="95%" stopColor="#d71920" stopOpacity={0} /></linearGradient></defs>
                      ...
                      <Area type="monotone" dataKey="ventas" stroke="#d71920" strokeWidth={2.5} fill="url(#g)" dot={false} activeDot={{ r: 5, fill: "#d71920" }} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
                <div style={card}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
                    ...
                    <button onClick={() => setActiveNav("Productos")} style={{ fontSize: 12, color: "#d71920", background: "none", border: "none", cursor: "pointer", fontWeight: 600 }}>Ver todos →</button>
                  </div>
              ...
              <div style={card}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
                  ...
                  <button onClick={() => setActiveNav("Recibos")} style={{ fontSize: 12, color: "#d71920", background: "none", border: "none", cursor: "pointer", fontWeight: 600 }}>Ver todas →</button>
                </div>
                {boletas.length === 0
                  ...
                  : boletas.slice(0, 4).map(b => (
                    <div key={b.numero} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10, padding: "10px 14px", background: bgCard2, borderRadius: 12, cursor: "pointer" }} onClick={() => setBoletaModal(b)}>
                      <div style={{ width: 36, height: 36, borderRadius: 10, background: D ? "rgba(215,25,32,0.15)" : "#fff3bf", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <Receipt size={16} color="#d71920" />
                      </div>
                      <div style={{ flex: 1 }}>
          ...
          {activeNav === "Gastos" && (
            <div className="fade-in empty-state">
              <div style={{ width: 56, height: 56, borderRadius: 16, background: D ? "rgba(79,174,147,0.15)" : "#e4f0ec", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
                <DollarSign size={26} color={D ? "#ffc400" : "#d71920"} strokeWidth={1.8} />
              </div>
